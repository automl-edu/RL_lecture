...
\begin{frame}[c]{Variations on the idea}
	...
	\begin{itemize}
		\item The same method can be applied to continuously parametrized environments \lit{\href{https://arxiv.org/pdf/1910.07224.pdf}{Portelas et al., 2019}}
		\item The teacher can be a failsafe in safety-critcal applications \lit{\href{https://papers.nips.cc/paper/2020/file/8df6a65941e4c9da40a4fb899de65c55-Paper.pdf}{Turchetta et al., 2020}}
